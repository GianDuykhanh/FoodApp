...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Response<?>> handlePaymentProcessingExceptions(PaymentProcessingException ex){
        Response<?> response = Response.builder()
    ...
    public ResponseEntity<Response<?>> handleUnauthorizedAccessExceptions(UnauthorizedAccessException ex){
        Response<?> response = Response.builder()
    ...
    public ResponseEntity<Response<?>> handleIllegalArgumentExceptions(IllegalArgumentException ex){
        Response<?> response = Response.builder()
                .statusCode(HttpStatus.BAD_REQUEST.value())
                .message(ex.getMessage())
                .build();
