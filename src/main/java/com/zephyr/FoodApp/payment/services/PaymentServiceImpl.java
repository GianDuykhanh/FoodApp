...
import com.zephyr.FoodApp.payment.repository.PaymentRepository;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public void updatePaymentForOrder(PaymentDTO paymentDTO) {
        ...
        if (!paymentDTO.isSuccess()) {
            payment.setFailureReasons(paymentDTO.getFailureReasons());
        }
        ...
        if (paymentDTO.isSuccess()) {
            ...
            context.setVariable("failureReason", paymentDTO.getFailureReasons());
